...
import { Mail, Lock, LogIn, Target, AlertCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-500 font-medium mt-2 text-center leading-relaxed">
            Welcome back! Log in to keep your streak alive.
          </p>
        </div>
        ...
        <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
          ...
          <div className="mt-8 pt-8 border-t border-slate-50 text-center">
            <p className="text-slate-500 font-medium text-sm">
              ...
              <Link to="/signup" className="text-indigo-600 font-black hover:text-indigo-700 underline decoration-indigo-200 decoration-2 underline-offset-4">
                Sign Up for Free
              </Link>
            </p>
          </div>
